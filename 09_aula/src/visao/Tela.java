...
public class Tela {
	public Cliente desenharIncluir() {
	 ...
	 public static void exibirMedia(List<Cliente>banco) {
		 Util util = new Util();
		 System.out.println("Amedia das idades é : " + util.calcularMedia(banco));
	...
	public int excluirCliente(List<Cliente>banco) {
	 ...
	 public void clasificarCliente(List<Cliente>banco) {
